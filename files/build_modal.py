...
PICKER_HEADER_HTML = (
    "\"<div style='display:grid;grid-template-columns:36px 60px 240px 120px 60px 60px 60px;"
    ...
    "<span>SEL</span><span>OP NO.</span><span>OPERATION SHORT TEXT</span><span>MAIN WORK CENTER</span>"
    "<span>CTRL</span><span>WORK</span><span>DUR.</span></div>\""
)
...
def build_tasklist_picker_modal():
    ...
    listWrap = group("conVhpPickerListWrap", [headHtml, divider, gallery], direction="Vertical", gap=4,
                     height=22 + 4 + 1 + 280, overflow_y="Scroll", width=636)
    ...
    modal = group(
        ...
        height=32 + 12 + 36 + 12 + 18 + 12 + (22 + 4 + 1 + 280) + 12 + 36,
