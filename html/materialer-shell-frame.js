(function () {
  ...
  document.addEventListener("DOMContentLoaded", initMaterialerShellFrame);

  function initMaterialerShellFrame() {
    const frame = document.querySelector("iframe[data-materialer-frame]");
    if (!frame) return;

    const hero = document.querySelector(".site-hero");
    const emailButton = document.getElementById("btnSendEmailMaterialerShell");
